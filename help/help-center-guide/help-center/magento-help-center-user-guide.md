...
>
>Si vous ne parvenez pas à sélectionner un autre produit (par exemple, le menu déroulant **Sélectionner un produit** est vide ou ne s’affiche pas), cela est généralement dû à l’une des raisons suivantes :
>
...
Vous pouvez consulter les cas Commerce que vous avez soumis personnellement en cliquant sur **[!UICONTROL My Cases]** dans le menu de gauche. Assurez-vous d’avoir sélectionné l’organisation appropriée se terminant par « (Commerce) ».
...
Vous pouvez afficher les cas Commerce auxquels vous avez été *ajouté en tant qu’observateur* en cliquant sur **[!UICONTROL My organization's cases]** dans le menu de gauche.
