...
* Adobe Commerce (toutes les méthodes de déploiement) 2.2.x, 2.3.x
...
Effacez la variable `<magento_root>/generated/code` et autres répertoires sous `var` et `generated` comme suit :
