...
1. Vérifiez que les [[!UICONTROL indexers]](https://experienceleague.adobe.com/en/docs/commerce-operations/configuration-guide/cli/manage-indexers) (dans notre documentation destinée aux développeurs) sont en cours d’exécution et que le [!UICONTROL indexer] `Product Feed` est défini sur `Update by Schedule`.
...
* [Consulter les journaux et résoudre les problèmes](https://experienceleague.adobe.com/en/docs/commerce/saas-data-export/logs-troubleshooting/troubleshooting-logging) dans le Guide d’exportation des données [!DNL SaaS]
