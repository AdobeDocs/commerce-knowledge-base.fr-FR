...
* Vous passez à une liste de distribution ou à une adresse e-mail fourre-tout.
...
L’adresse e-mail de votre compte [Magento.com](https://account.magento.com) est liée à votre compte Adobe à l’adresse <https://account.adobe.com> et devra y être mise à jour.

## Étapes de modification de l’adresse e-mail

### Cas I :

Modification de l’adresse e-mail d’un utilisateur disposant de son propre compte sur <https://account.adobe.com>
...
1. Demandez à l’équipe de fusionner les deux comptes afin de mettre à jour l’adresse e-mail sur le compte existant.

### Cas II :

Modification de l’adresse e-mail d’un utilisateur qui ne dispose pas actuellement de son propre compte sur <https://account.adobe.com>
...
1. Configurez le transfert d’e-mail de l’e-mail [propriétaire actuel] vers un nouvel e-mail à l’aide de la configuration du serveur de messagerie de votre entreprise.
1. Procédez maintenant aux étapes précédentes.
