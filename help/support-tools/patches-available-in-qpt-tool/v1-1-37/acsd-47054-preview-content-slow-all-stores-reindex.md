...
Le correctif ACSD-47054 corrige le problème lorsqu’un aperçu de l’évaluation du contenu prend plus de temps à se charger lorsqu’il y a de nombreux magasins. Ce correctif est disponible lorsque la variable [[!DNL Quality Patches Tool (QPT)]](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) La version 1.1.37 est installée. L’ID de correctif est ACSD-47054. Veuillez noter que le problème a été corrigé dans Adobe Commerce 2.4.6.
