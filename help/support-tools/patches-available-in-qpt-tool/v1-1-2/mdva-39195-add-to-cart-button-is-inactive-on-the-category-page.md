...
Le correctif MDVA-39195 résout le problème où la variable **Ajouter au panier** est inactif sur la page Catégorie lorsque la redirection vers le panier est activée. Ce correctif est disponible lorsque la variable [Outil Correctifs de qualité (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) La version 1.1.2 est installée. L’ID de correctif est MDVA-39195. Veuillez noter que le problème a été corrigé dans Adobe Commerce 2.4.3.
...
La variable **Ajouter au panier** est inactif sur la page Catégorie lorsque la redirection vers le panier est activée.

<u>Étapes à reproduire</u>:

1. Accédez à **Magasins** > Paramètres > **Configuration** > **Ventes** > **Passage en caisse**.
1. Développez l’objet **Panier** .
1. Définissez la variable **Après avoir ajouté une redirection de produit au panier** sur Oui.
...
**Ajouter au panier** est inactif sur la page Catégorie.
