...
# ACSD-52786 : règle de catalogue &quot;*[!UICONTROL SKU is]*&quot; s’applique à tous les produits commençant par le SKU.

Le correctif ACSD-52786 corrige le problème de condition de règle de catalogue. *[!UICONTROL SKU is]* s’applique à tous les produits commençant par le SKU donné. Ce correctif est disponible lorsque la variable [!DNL Quality Patches Tool (QPT)] La version 1.1.35 est installée. L’ID de correctif est ACSD-52786. Veuillez noter que le problème a été corrigé dans Adobe Commerce 2.4.7.
...
Condition de règle du catalogue *[!UICONTROL SKU is]* s’applique à tous les produits commençant par le SKU donné.
...
1. Appliquez la condition suivante :
   * *[!UICONTROL If ** TOUT **de ces conditions** TRUE **]*: *[!UICONTROL SKU is 24]*
