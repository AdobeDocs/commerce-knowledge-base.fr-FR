...
Le correctif ACSD-52689 corrige le problème où les images ne peuvent pas être téléchargées vers le stockage Amazon S3 à l’aide de l’API REST Ce correctif est disponible lorsque la variable [!DNL Quality Patches Tool (QPT)] La version 1.1.34 est installée. L’ID de correctif est ACSD-52689. Veuillez noter que le problème doit être corrigé dans Adobe Commerce 2.4.7.
