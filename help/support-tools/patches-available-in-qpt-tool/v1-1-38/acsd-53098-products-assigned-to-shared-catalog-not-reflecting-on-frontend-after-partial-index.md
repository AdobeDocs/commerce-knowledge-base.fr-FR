...
Le correctif ACSD-53098 corrige le problème en raison duquel les produits affectés à un catalogue partagé ne reflètent pas sur l’interface lors de l’exécution d’un index partiel. Ce correctif est disponible lorsque la variable [!DNL Quality Patches Tool (QPT)] La version 1.1.38 est installée. L’ID de correctif est ACSD-53098. Veuillez noter que le problème doit être corrigé dans Adobe Commerce 2.4.7.
...
1. Configuration [!DNL RabbitMQ] comme service de file d’attente.
1. Basculez les indexeurs vers **[!UICONTROL Update on Schedule]** mode .
