...
description: Le correctif MDVA-41628 corrige le problème en raison duquel les utilisateurs administrateurs limités peuvent accéder aux nouvelles ressources lors de l’ajout de nouveaux modules. Ce correctif est disponible lorsque l’[outil de correctifs de qualité (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.12 est installé. L’ID de correctif est MDVA-41628. Veuillez noter que le problème doit être corrigé dans Adobe Commerce 2.4.5.
...
Le correctif MDVA-41628 corrige le problème en raison duquel les utilisateurs administrateurs limités peuvent accéder aux nouvelles ressources lors de l’ajout de nouveaux modules. Ce correctif est disponible lorsque la variable [Outil Correctifs de qualité (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) La version 1.1.12 est installée. L’ID de correctif est MDVA-41628. Veuillez noter que le problème doit être corrigé dans Adobe Commerce 2.4.5.
