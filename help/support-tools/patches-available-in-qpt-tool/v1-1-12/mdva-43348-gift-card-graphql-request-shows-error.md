...
Le correctif MDVA-43348 corrige le problème en raison duquel la demande de GraphQL de carte cadeau affichait une erreur si `gift_card_options` contenait &quot;uid&quot;. Ce correctif est disponible lorsque l’[outil de correctifs de qualité (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.12 est installé. L’ID de correctif est MDVA-43348. Veuillez noter que le problème doit être corrigé dans Adobe Commerce 2.4.5.
