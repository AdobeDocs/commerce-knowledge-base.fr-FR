...
Le correctif MDVA-42950 résout le problème en raison duquel les vidéos ne sont pas lues sur la page du produit. Ce correctif est disponible lorsque la variable [Outil Correctifs de qualité (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) La version 1.1.12 est installée. L’ID de correctif est MDVA-42950. Veuillez noter que le problème doit être corrigé dans Adobe Commerce 2.4.5.
...
1. Ajouter un HTML HEADER dans Contenu > **Conception** > **Configuration** > **HTML Head** > **Scripts et feuilles de style**:
