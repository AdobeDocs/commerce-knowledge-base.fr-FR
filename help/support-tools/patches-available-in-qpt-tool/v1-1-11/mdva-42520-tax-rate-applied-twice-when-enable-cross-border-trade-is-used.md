...
Le correctif MDVA-42520 corrige le problème où le taux de taxe est appliqué deux fois lorsque la variable **Activer le commerce transfrontalier** est utilisée. Ce correctif est disponible lorsque la variable [Outil Correctifs de qualité (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) La version 1.1.11 est installée. L’ID de correctif est MDVA-42520. Veuillez noter que le problème doit être corrigé dans Adobe Commerce 2.4.5.
...
Le taux de la taxe est appliqué deux fois lorsque la variable **Activer le commerce transfrontalier** est utilisée.

<u>Étapes à reproduire</u>:

1. Activer **Société**, **Catalogue partagé**, et **Citation**
1. Paramétrez les taxes en fonction de la capture d&#39;écran. Assurez-vous d’activer **Commerce transfrontalier**.
