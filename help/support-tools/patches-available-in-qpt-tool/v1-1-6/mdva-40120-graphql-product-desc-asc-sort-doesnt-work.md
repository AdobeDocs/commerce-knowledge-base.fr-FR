...
Le correctif MDVA-40120 résout le problème en raison duquel le tri GraphQL par DESC/ASC ne fonctionne pas avec des produits ayant la même pertinence ou le même prix. Ce correctif est disponible lorsque la variable [Outil Correctifs de qualité (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) La version 1.1.6 est installée. L’ID de correctif est MDVA-40120. Veuillez noter que le problème doit être corrigé dans Adobe Commerce 2.4.4.
...
1. Modifiez l’ordre de tri à partir de **ASC** to **DESC** dans la requête GraphQL :
   <pre>
    <code class="language-graphql">
    {
