...
Le correctif MDVA-30862 corrige le problème en raison duquel une date de commande incorrecte était imprimée sur la facture du PDF. Ce correctif est disponible lorsque la variable [Outil Correctifs de qualité (QPT)](https://devdocs.magento.com/guides/v2.4/comp-mgr/patching.html#mqp) La version 1.1.6 est installée. L’ID de correctif est MDVA-30862. Veuillez noter que le problème a été corrigé dans Adobe Commerce 2.4.0.
