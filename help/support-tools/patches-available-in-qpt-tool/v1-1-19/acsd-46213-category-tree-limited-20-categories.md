...
Le correctif ACSD-46213 corrige le problème lorsque la requête d’arborescence de catégorie est limitée à 20 catégories. Ce correctif est disponible lorsque la variable [Outil Correctifs de qualité (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) La version 1.1.19 est installée. L’ID de correctif est ACSD-46213.
