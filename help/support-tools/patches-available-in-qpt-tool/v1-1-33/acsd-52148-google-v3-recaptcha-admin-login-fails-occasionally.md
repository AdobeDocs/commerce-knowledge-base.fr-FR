...
Le correctif ACSD-52148 corrige le problème d’échec occasionnel de la connexion de l’administrateur reCAPTCHA de Google v3. Ce correctif est disponible lorsque la variable [!DNL Quality Patches Tool (QPT)] La version 1.1.33 est installée. L’ID de correctif est ACSD-52148. Veuillez noter que le problème doit être corrigé dans Adobe Commerce 2.4.6.
...
* *La vérification reCAPTCHA a échoué.* s’affiche parfois.
