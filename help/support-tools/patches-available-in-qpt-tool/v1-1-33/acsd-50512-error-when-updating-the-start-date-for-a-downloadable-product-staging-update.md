...
Le correctif ACSD-50512 corrige le problème où l’erreur *Le lien téléchargeable n’est pas lié au produit. Vérifier le lien et réessayer*, survient lors de la mise à jour de la date de début d’une mise à jour intermédiaire de produit téléchargeable. Ce correctif est disponible lorsque la variable [!DNL Quality Patches Tool (QPT)] La version 1.1.33 est installée. L’ID de correctif est ACSD-51502. Veuillez noter que le problème doit être corrigé dans Adobe Commerce 2.4.7.
...
L&#39;erreur *Le lien téléchargeable n’est pas lié au produit. Vérifier le lien et réessayer*, survient lors de la mise à jour de la date de début d’une mise à jour intermédiaire de produit téléchargeable.

<u>Étapes à reproduire</u>:

1. Créez un produit téléchargeable, avec *liens téléchargeables* et *exemples de liens*.
...
Vous obtenez l’erreur : *Le lien téléchargeable n’est pas lié au produit. Vérifier le lien et réessayer*.
