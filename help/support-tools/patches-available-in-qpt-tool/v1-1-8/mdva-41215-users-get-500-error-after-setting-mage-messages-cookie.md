...
description: Le correctif MDVA-41215 corrige le problème qui entraînait une erreur 500 pour les utilisateurs après avoir défini le cookie "image-messages" s’il existe déjà, mais qu’il n’y avait aucun nouveau message. Ce correctif est disponible lorsque l’[outil de correctifs de qualité (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) 1.1.8 est installé. L’ID de correctif est MDVA-41215. Veuillez noter que le problème doit être corrigé dans Adobe Commerce 2.4.4.
