...
Installation d’Adobe Commerce avec [Inventory management](https://devdocs.magento.com/guides/v2.4/inventory/).
...
1. Créez un lot de produits (créez deux options de liste déroulante pour les produits enfants et affectez des produits simples et virtuels.). Définir **Prix dynamique** = *Non*.
