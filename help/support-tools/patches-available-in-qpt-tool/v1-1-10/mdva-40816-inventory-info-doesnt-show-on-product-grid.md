...
Le correctif MDVA-40816 résout le problème en raison duquel les informations d’inventaire ne s’affichent pas sur la grille de produit si un SKU de produit contient des caractères spéciaux. Ce correctif est disponible lorsque la variable [Outil Correctifs de qualité (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) La version 1.1.10 est installée. L’ID de correctif est MDVA-40816. Veuillez noter que le problème doit être corrigé dans Adobe Commerce 2.4.5.
