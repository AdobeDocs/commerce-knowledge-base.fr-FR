...
Le correctif MDVA-37748 corrige le problème lorsqu’une requête GraphQL renvoie des produits non affectés à un catalogue partagé. Ce correctif est disponible lorsque la variable [Outil Correctifs de qualité (QPT)](https://devdocs.magento.com/guides/v2.4/comp-mgr/patching.html#mqp) La version 1.1.5 est installée. L’ID de correctif est MDVA-37748. Veuillez noter que le problème doit être corrigé dans Adobe Commerce 2.4.4.
...
1. Ajouter un en-tête **Valeur du jeton du porteur d’autorisation** et exécutez la requête GraphQL suivante :
...
Seul &quot;Product 2&quot; est renvoyé, mais la variable `total_count` affiche deux.
