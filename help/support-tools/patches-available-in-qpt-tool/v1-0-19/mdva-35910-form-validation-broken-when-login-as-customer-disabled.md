...
Le correctif MDVA-35910 résout le problème en raison duquel la validation du formulaire de création de compte client est interrompue lorsque la variable **Connexion en tant que client** est désactivée. Ce correctif est disponible lorsque la variable [Outil Correctifs de qualité (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) La version 1.0.19 est installée. L’ID de correctif est MDVA-35910. Veuillez noter que le problème a été corrigé dans Adobe Commerce version 2.4.3.
...
1. Accédez à **Magasins > Configuration > Clients**. Désactiver **Connexion en tant que client** dans Admin.
1. Sous **Connexion en tant que client**, définit **Activer l’extension** = *Non*.
1. Enregistrez la configuration et videz le cache.
1. Revenez au storefront, puis cliquez sur **Enregistrer** (Créez un compte client).
1. Remplissez le formulaire du compte et vérifiez si la validation sous **Confirmer le courrier électronique** fonctionne ou non.
