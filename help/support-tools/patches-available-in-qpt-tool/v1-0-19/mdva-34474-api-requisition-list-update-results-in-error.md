...
1. Activez la liste des demandes dans Admin (**Magasins** > **Configuration** > **Général** > **Fonctionnalités B2B** > **Activer la liste des demandes** = *Oui*).
1. Créez un client.
1. Créez une nouvelle liste de demande pour cet appel d’envoi de client ```json    POST rest/all/V1/requisition_lists``` avec la charge utile json associée.
