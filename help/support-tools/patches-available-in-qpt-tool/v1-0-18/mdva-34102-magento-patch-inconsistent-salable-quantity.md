...
1. Ajoutez un produit simple :
   * Définissez **Activer le produit** = *Non*.
   * Attribuez deux sources avec **Source Item Status** = *In Stock* avec une quantité supérieure à zéro (par exemple : **default stock** = *123* et **UK stock** = *123*).
