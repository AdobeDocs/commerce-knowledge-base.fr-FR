...
Le correctif MDVA-37362 résout le problème en raison duquel les valeurs d’option de produit configurables et les valeurs d’attribut de variante sont vides dans la réponse GraphQL. Ce correctif est disponible lorsque la variable [Outil Correctifs de qualité (QPT)](https://devdocs.magento.com/guides/v2.4/comp-mgr/patching.html#mqp) v.1.0.23 est installé. Veuillez noter que le problème doit être corrigé dans Adobe Commerce version 2.4.3.
...
1. **Magasins** > *Paramètres* > **Configuration** > **Catalogue** > **Inventaire** > *Options d’inventaire des produits* > Gérer les stocks : *OUI*.
