...
Le correctif MDVA-44660 corrige le problème où le caractère accent grave [\`] ne peut pas être utilisé pour le nom d’un client. Ce correctif est disponible lorsque la variable [Outil Correctifs de qualité (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) La version 1.1.15 est installée. L’ID de correctif est MDVA-44660. Veuillez noter que le problème doit être corrigé dans Adobe Commerce 2.4.5.
...
Caractère d’accent grave [\`] ne peut pas être utilisé pour le prénom et le nom d’un client.
...
*Prénom n’est pas valide !* Ou *Nom non valide* s’affiche.
