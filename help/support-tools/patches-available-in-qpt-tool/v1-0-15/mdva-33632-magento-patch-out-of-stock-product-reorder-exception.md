...
Le client reçoit le *Ce produit est en rupture de stock.*&quot; pour un produit en rupture de stock, comme prévu.

<u>Résultats réels</u>:

Le client reçoit le *Ce produit est en rupture de stock.*&quot; message et `var/log/exception.log` contient une exception similaire :
