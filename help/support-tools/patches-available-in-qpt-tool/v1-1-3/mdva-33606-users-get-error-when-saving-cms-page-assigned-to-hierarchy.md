...
Le correctif MDVA-33606 résout le problème où les utilisateurs obtiennent *Violation de contrainte unique détectée* lors de l’enregistrement d’une page CMS affectée à l’arborescence de hiérarchie. Ce correctif est disponible lorsque la variable [Outil Correctifs de qualité (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) La version 1.1.3 est installée. L’ID de correctif est MDVA-33606. Veuillez noter que le problème a été corrigé dans Adobe Commerce 2.4.3.
...
1. Accédez à **Contenu** > **Hiérarchie** > Ajoutez la page 1 du CMS à l’arborescence.
...
1. Accédez à **Contenu** > **Pages** > **Ajouter une nouvelle page**.
   ...
   * Dans la section Page des sites web, affectez-vous à Toutes les vues de magasin et aux deux vues de magasin (mode magasin par défaut et mode magasin 2), puis cliquez sur **Enregistrer la page**.
...
Vous obtenez l’erreur suivante : *Violation de contrainte unique détectée*.
