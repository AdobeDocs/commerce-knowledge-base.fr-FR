...
Le correctif MDVA-36309 résout le problème de lenteur de la recherche de produits par attributs dans les grilles d’administration. Ce correctif est disponible lorsque la variable [Outil Correctifs de qualité (QPT)](/help/announcements/adobe-commerce-announcements/magento-quality-patches-released-new-tool-to-self-serve-quality-patches.md) La version 1.1.3 est installée. L’ID de correctif est MDVA-36309. Veuillez noter que le problème a été corrigé dans Adobe Commerce 2.4.3.
